...
public class Account implements IAccount {
     ...
     * 
     * @param accountId
     *            the ID to be set for the account
     */
     ...
     * 
     * @param fullName
     *            the fullname of the user to be set for the account
     */
     ...
     * 
     * @param displayName
     *            the display name to be set for the account
     */
     ...
     * 
     * @param balance
     *            the balance to be set for the account
     */
     ...
     * 
     * @param monthlyInterest
     *            the monthly interest to be est for the account
     */

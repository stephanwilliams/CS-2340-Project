...
/**
 * Manages creation and updating of the database.
 */
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * Instantiates a DatabaseHelper given a context.
     * 
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE accounts ("
                ...
                + "username TEXT NOT NULL," + "fullName TEXT NOT NULL,"
        ...
        db.execSQL("CREATE TABLE transactions ("
                ...
                + "type INTEGER NOT NULL," + "amount TEXT NOT NULL,"
                + "category TEXT NOT NULL," + "reason TEXT" + ");");
    }
